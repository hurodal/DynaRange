...
#define DEBUG_IA_ON 0 // Set to 1 ONLY for specific AI debugging tasks
    ...
    // El código solo se incluirá si DYNA_RANGE_DEBUG_MODE es 1.
    ...
    namespace DynaRange::Debug {
        ...
        // Activa el guardado de imágenes intermedias durante la preparación (pre/post keystone, crop area).
        constexpr bool ENABLE_KEYSTONE_CROP_DEBUG = true;
